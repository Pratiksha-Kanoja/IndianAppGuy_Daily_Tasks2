...
async function pros_cons2_appScript({ result, firstSlideNumberToStart, wikipediaSearchSuccess, colornfonts, userEmail, isColorfonts, slide }) {
    ...
    try {
        ...
        titleStyle2.setFontFamily('League Spartan')
        title2.setTop(30)
        title2.setLeft(45)
        title2.setWidth(650)
        ...
        description.setLeft(130)
        description.setWidth(430)
        descStyle.setForegroundColor('#000000')
        descStyle.setFontSize(11)
        descStyle.setFontFamily('Inter')
        ...
        description2.setLeft(130)
        description2.setWidth(430)
        descStyle2.setForegroundColor('#000000')
        descStyle2.setFontSize(11)
        descStyle2.setFontFamily('Inter')
        ...
        description3.setLeft(130)
        description3.setWidth(430)
        descStyle3.setForegroundColor('#000000')
        descStyle3.setFontSize(11)
        descStyle3.setFontFamily('Inter')
        ...
        description4.setLeft(130)
        description4.setWidth(430)
        descStyle4.setForegroundColor('#000000')
        descStyle4.setFontSize(11)
        descStyle4.setFontFamily('Inter')
