...
async function pros_cons2_appScript({ result, firstSlideNumberToStart, wikipediaSearchSuccess, colornfonts, userEmail, isColorfonts, slide }) {
    ...
    try {
        ...
        subtitle1.setTop(105)
        subtitle1.setLeft(90)
        ...
        subtitle2.setTop(105)
        subtitle2.setLeft(390)
        ...
        subtitle3.setTop(245)
        subtitle3.setLeft(90)
        ...
        subtitle4.setTop(245)
        subtitle4.setLeft(390)
