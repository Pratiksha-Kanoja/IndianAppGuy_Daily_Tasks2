...
async function pros_cons2({ slideTitle, slideDesc, myAccountInfo, userEmail, presentationId, firstSlideNumberToStart, wikipediaSearchSuccess, language, colornfonts, isColorfonts, slide }) {
    try {
        var prompt = `Craft a JSON for a presentation slide object with ${slideTitle} and slide description: ${slideDesc} should have:
          ...
          n) 'description5' – string of 4 lines covering specific information or examples relevant to the slide's topic. description3 should me more than 30 words and less than 30 words.
          o) 'description6' – string of 4 lines covering specific information or examples relevant to the slide's topic. description3 should me more than 30 words and less than 30 words.`
...
async function pros_cons2_appScript({ result, firstSlideNumberToStart, wikipediaSearchSuccess, colornfonts, userEmail, isColorfonts, slide }) {
    ...
    try {
        ...
        shape5.getBorder().setTransparent();
        shape5.setWidth(200)
        shape5.setHeight(120)
        shape5.setTop(240)
        shape5.setLeft(250)
        shape5.getFill().setSolidFill('#ffffff')

        const shape6 = slide.insertShape(SlidesApp.ShapeType.RECTANGLE)
        shape6.getBorder().setTransparent();
        shape6.setWidth(200)
        shape6.setHeight(120)
        shape6.setTop(240)
        shape6.setLeft(480)
