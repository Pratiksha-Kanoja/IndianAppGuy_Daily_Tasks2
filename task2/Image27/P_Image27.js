...
async function pros_cons2_appScript({ result, firstSlideNumberToStart, wikipediaSearchSuccess, colornfonts, userEmail, isColorfonts, slide }) {
    ...
    try {
        ...
        sub1Style.setForegroundColor('#2d11ee')
        ...
        sub2Style.setForegroundColor('#2d11ee')
        ...
        sub3Style.setForegroundColor('#2d11ee')
        sub3.getText().getParagraphStyle().setParagraphAlignment(SlidesApp.ParagraphAlignment.CENTER)
        sub3Style.setBold(true)
        sub3.setTop(190)
        sub3.setLeft(390)
        sub3.setWidth(120)

        const sub4 = slide.insertTextBox(result.subtitle4)
        const sub4Style = sub4.getText().getTextStyle()
        sub4Style.setFontSize(14)
        sub4Style.setFontFamily('League Spartan')
        sub4Style.setForegroundColor('#2d11ee')
        sub4Style.setBold(true)
        sub4.setTop(190)
        sub4.setLeft(560)
        sub4.setWidth(120)
